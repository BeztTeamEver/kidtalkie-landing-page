            ...
            <div className="flex flew-row gap-10 p-4 flex-wrap lg:flex-nowrap justify-center">
                <div className="flex flex-col border rounded-lg1 p-10 text-center shadow-2xl w-1/2 lg:w-1/3">
                    ...
                    <p className="font-inter font-normal text-lg text-neutral-600 mt-10">
                        Một cơ hội tuyệt vời để phụ huynh và bé khám phá và trải nghiệm mọi tính năng nổi bật
                        trên KidTalkie một cách dễ dàng và thoải mái.
                        <br />
                ...
                <div className="flex flex-col border rounded-lg1 p-10  text-center shadow-2xl w-1/2 lg:w-1/3">
                    ...
                    <p className="font-inter font-normal italic text-lg text-neutral-600">
                        1 tài khoản gia đình/1 tháng
                    </p>
                    <p className="font-inter font-normal text-lg text-neutral-600 mt-10">
                        Gồm các tính năng cơ bản đủ để bé tự do phát triển và gắn kết với bạn bè. Tuy nhiên ở
                ...
                <div className="flex flex-col border rounded-lg1 p-10 text-center shadow-2xl w-1/2 lg:w-1/3">
                    ...
                    <p className="font-inter font-normal text-lg text-neutral-600 mt-10">
                        Phụ huynh và bé được trải nghiệm toàn diện tất cả tính năng hiện có của KidTalkie: Vui
                        chơi, Sáng tạo, An toàn và Kết nối{' '}
                    </p>
                </div>
            </div>
